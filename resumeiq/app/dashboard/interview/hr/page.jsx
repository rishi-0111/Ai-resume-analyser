  ...
  const renderHeader = () => {
    ...
    return (
      <div className="flex items-center gap-2 text-sm text-muted mb-8">
        ...
        <span className="text-primary-text font-medium">HR Interview</span>
        {setupData.role && (
          <>
            <ChevronRight className="w-4 h-4" />
        ...
        {loading && (
          ...
          >
            ...
            <p className="text-secondary-text text-sm max-w-sm text-center">
              {step === STEPS.GENERATING
                ? "The AI is reviewing your resume and preparing the first question."
          ...
          >
            <div>
              ...
              <p className="text-secondary-text">
                Select the resume you want to use for this HR interview.
              </p>
            </div>
            <ResumeSelector
        ...
        {!loading && !error && step === STEPS.SETUP && (
          ...
          >
            ...
            <div className="text-center mb-8">
              <h1 className="font-heading text-2xl font-bold mb-2">Configure Your Interview</h1>
              <p className="text-secondary-text text-sm">
                Provide some details so the AI can tailor the conversation.
              </p>
            </div>
            <InterviewSetup
              value={setupData}
        ...
        {!loading && !error && step === STEPS.RESULTS && results && (
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <h1 className="font-heading text-3xl font-bold mb-2">HR Interview Report</h1>
                <p className="text-secondary-text">
                  Your personalized behavioral performance review.
                </p>
              </div>
